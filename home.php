...
<body class="text-light">
    ...
    <main>
        <div class="col-lg-12">
            <h1 class="fw-bolder text-center" id="project-title">Spotiplay</h1>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header py-1">
                            <div class="d-flex w-100">
                                <h5 class="card-title col-auto flex-grow-1 flex-shrink-1 text-primary">Music List</h5>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <ul class="list-group" id="music-list">
                                <?php 
                                $music = $conn->query('SELECT * FROM `music` order by title asc');
                                while($row = $music->fetch_assoc()):
                                ?>
                                <li class="list-group-item list-group-item-action item" data-id="<?= $row['id'] ?>">
                                    <div class="d-flex w-100 align-items-center">
                                        <div class="col-auto pe-2">
                                            <img src="<?= is_file(explode("?",$row['image_path'])[0]) ? $row['image_path'] : "./images/default.jpg" ?>" alt="" class="img-thumbnail bg-gradient bg-dark mini-display-img">
                                        </div>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="col-md-12 text-center">
                            <img src="./images/default.jpg" alt="" id="display-img" class="img-fluid border bg-gradient bg-dark">
                        </div>
                    ...
                    <div class="container-fluid">
                        <form action="" id="music-form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" required placeholder="Music name">
                            </div>
                            <div class="form-group mb-3">
                                <label for="description" class="control-label">Description</label>
                                <textarea rows="3" name="description" id="description" class="form-control form-control-sm rounded-0" required placeholder="Music description"></textarea>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3 text-center">
                                <div class="col-md-6">
                                <img src="./images/default.jpg" alt="Image" class="img-fluid img-thumbnail bg-gradient bg-dark" id="dImage">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="container-fluid">
                        <form action="" id="update-music-form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title" id="title2" class="form-control form-control-sm rounded-0" required placeholder="Music name">
                            </div>
                            <div class="form-group mb-3">
                                <label for="description2" class="control-label">Description</label>
                                <textarea rows="3" name="description" id="description2" class="form-control form-control-sm rounded-0" required placeholder="Music description"></textarea>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3 text-center">
                                <div class="col-md-6">
                                <img src="./images/default.jpg" alt="Image" class="img-fluid img-thumbnail bg-gradient bg-dark" id="dImage2">
                                </div>
                            </div>
                        </form>
                    </div>
